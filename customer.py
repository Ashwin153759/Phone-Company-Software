...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        """
        calling_number = call.src_number

        for phone_number in self._phone_lines:
            if calling_number == phone_number.number:
                phone_number.make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        """
        receiving_number = call.dst_number

        for phone_number in self._phone_lines:
            if receiving_number == phone_number.number:
                phone_number.receive_call(call)
